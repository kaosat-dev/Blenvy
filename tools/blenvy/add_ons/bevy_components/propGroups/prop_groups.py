...
def update_component(self, context, definition, component_name):
    print("update component", component_name, definition)
    ...
    print("components in object", components_in_object)
    ...
    if component_meta is not None:
        ...
        print("property_group_name", property_group_name, property_group)
...
def generate_propertyGroups_for_components():
    print("generate_propertyGroups_for_components")
    registry = bpy.context.window_manager.components_registry
    ...
    for root_type_name in type_infos:
        print("processing", root_type_name)
