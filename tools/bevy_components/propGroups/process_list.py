...
def process_list(registry, definition, update, component_name_override=None):
    ...
    (list_content_group, list_content_group_class) = process_component.process_component(registry, original, update, {"nested": True, "type_name": original_long_name}, component_name_override)
